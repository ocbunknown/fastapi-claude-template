...
from src.database.psql.queries.executor import QueryExecutor
from src.database.psql.repositories.role import RoleRepository
from src.database.psql.repositories.user import UserRepository
...
class DBGateway(BaseGateway):
    ...
    def query_executor(self) -> QueryExecutor:
        return self._from_cache("query_executor", QueryExecutor)
